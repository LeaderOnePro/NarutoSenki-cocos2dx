...
#if !defined(HAVE_STRUCT_TIMESPEC) && !defined(_TIMESPEC_DEFINED) && !defined(__timespec_defined) && !defined(_CRT_NO_TIME_T) && !defined(_INC_TIME)
#define HAVE_STRUCT_TIMESPEC 1
#if defined(_MSC_VER) && _MSC_VER >= 1900
/* VS2015+ already has timespec in time.h, don't redefine */
#else
struct timespec {
        long tv_sec;
        long tv_nsec;
